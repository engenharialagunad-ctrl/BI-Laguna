...
var LAGUNA_DEFAULT_SOURCE_CATEGORY = "Cortes";
var LAGUNA_DEFAULT_SOURCE_NAME = "Perfis Corte";
var LAGUNA_DEFAULT_SHEET_PATTERN = "CRT PER";
...
function configureLagunaSourceFromMenu() {
  ...
  var categoryResponse = ui.prompt(
    ...
    "Informe a categoria desta planilha no BI Laguna. Ex.: Cortes, Producao, Entregas, Financeiro.\nAtual: " + currentCategory,
